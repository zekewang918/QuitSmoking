	...
	DIY.prototype = {
		...
		uploadSubmit : function (){
			if (document.uploadpic.attach.value.length<3) {
				alert('Please select the pictures you want to upload');
				return false;
			}
		...
		cancel : function () {
			var flag = false;
			if (this.isChange) {
				flag = confirm(this.cancelConfirm ? this.cancelConfirm : 'The exit will not save you just set. Are you sure to exit?');
			}
