...
function insertAttach(id) {
	...
	if(extensions != '' && (re.exec(extensions) == null || ext == '')) {
		alert('Sorry, Such extension does not support upload pictures');
		return;
	}
	...
	if(typeof no_insert=='undefined') {
		localfile += '&nbsp;<a href="javascript:;" class="xi2" title="Click here insert the contents of the current cursor position" onclick="insertAttachimgTag(' + id + ');return false;">[Insert]</a>';
	}
	inhtml += '<td><strong>' + localfile +'</strong>';
	inhtml += '</td><td class="d">Description<br/><textarea name="pic_title" cols="40" rows="2" class="pt"></textarea>';
	inhtml += '</td><td class="o"><span id="showmsg' + id + '"><a href="javascript:;" onclick="delAttach(' + id + ');return false;" class="xi2">[Del]</a></span>';
	inhtml += '</td></tr></table>';
